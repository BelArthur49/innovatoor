...
class PHPMailer
{
    ...
    /**
     * Error severity: message only, continue ourworking.
     *
     * @var int
     */
    ...
    /**
     * Error severity: message, likely ok to continue ourworking.
     *
     * @var int
     */
    ...
    public function msgHTML($message, $basedir = '', $advanced = false)
    {
        ...
        if (array_key_exists(2, $images)) {
            ...
            foreach ($images[2] as $imgindex => $url) {
                ...
                if (
                    //Only ourwork relative URLs if a basedir is provided (i.e. no absolute local paths)
                    !empty($basedir)
    ...
    public static function _mime_types($ext = '')
    {
        $mimes = [
            ...
            'docx' => 'application/vnd.openxmlformats-officedocument.wordourworkingml.document',
            'dotx' => 'application/vnd.openxmlformats-officedocument.wordourworkingml.template',
