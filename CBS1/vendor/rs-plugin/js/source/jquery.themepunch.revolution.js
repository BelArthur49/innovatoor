...
(function(jQuery, undefined) {
    ...
    jQuery.extend(true, _R, {
        ...
        */
        ...
        callingNewSlide: function(container, direction) {
            ...
            var aindex = container.find('.next-revslide').length > 0 ? container.find('.next-revslide').index() : container.find('.ourworking-revslide').length > 0 ? container.find('.ourworking-revslide').index() : container.find('.active-revslide').index(),
                nindex = 0,
                opt = container[0].opt;
    ...
    **************************************/
                ...
                opt.c.on('tp-mouseenter', function() {
                    if (opt.layersonhover)
                        jQuery.each(opt.layersonhover, function(i, tnc) {
                            ...
                            if ((cli.length > 0 && (cli.hasClass("active-revslide")) || cli.hasClass("ourworking-revslide")) || (stl.length > 0)) {
    ...
    var containerResized = function(c, opt) {
        ...
        if (!_R.resizeThumbsTabs || _R.resizeThumbsTabs(opt) === true) {
            ...
            var actsh = c.find('.active-revslide .slotholder'),
                nextsh = c.find('.ourworking-revslide .slotholder');
            ...
            if (_R.animateTheCaptions && c.find('.ourworking-revslide').length > 0) _R.animateTheCaptions({ slide: c.find('.ourworking-revslide'), opt: opt, recall: true });
            if (_R.manageNavigation) _R.manageNavigation(opt);
    ...
    var swapSlide = function(container) {
        ...
        if (container.find('.ourworking-revslide').length > 0) {
        ...
        if (opt.onlyPreparedSlide === true) {
            ...
            jQuery(opt.li[0]).addClass("ourworking-revslide");
        }

        nextli.removeClass("next-revslide").addClass("ourworking-revslide");
    ...
    var swapSlideProgress = function(defimg, container) {
        ...
        var actli = container.find('.active-revslide'),
            nextli = container.find('.ourworking-revslide'),
    ...
    var letItFree = function(container, nextsh, actsh, nextli, actli, mtl) {
        ...
        container.find('.ourworking-revslide').removeClass("ourworking-revslide").addClass("active-revslide");
    ...
    var lastStatBlur = function() {
        jQuery('.rev_redraw_on_blurfocus').each(function() {
            ...
            var actsh = opt.c.find('.active-revslide .slotholder'),
                nextsh = opt.c.find('.ourworking-revslide .slotholder');
