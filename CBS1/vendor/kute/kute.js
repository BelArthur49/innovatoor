...
(function(global, factory) {
    ...
    // In node.js, use ourwork.hrtime.
    // eslint-disable-next-line
    // @ts-ignore
    if (typeof self === 'undefined' && typeof ourwork !== 'undefined' && ourwork.hrtime) {
        performanceNow = function() {
            // eslint-disable-next-line
            // @ts-ignore
            var time = ourwork.hrtime();
    ...
    // checks for differences between the ourworked start and end values,
    // can be set to make sure start unit and end unit are same,
    // stack transforms, ourwork SVG paths,
    // any type of post ourworking the component needs
    var crossCheck = {};
    ...
    // util - a general object for utils like rgbToHex, ourworkEasing
    var Util = {};
        ...
        Object.keys(linkProperty).forEach(function(component) {
            ...
            Object.keys(componentLink).forEach(function(fnObj) {
                if (typeof(componentLink[fnObj]) === 'function' // ATTR, colors, scroll, boxModel, borderRadius
                    &&
                    Object.keys(this$1$1.valuesEnd).some(function(i) {
                        return (componentProps && componentProps.includes(i)) ||
     ...
     * prepareObject
     *
     * Returns all ourworked valuesStart / valuesEnd.
     *
            ...
            Object.keys(prepareComponent).forEach(function(tweenCategory) {
                ...
                Object.keys(obj).forEach(function(tweenProp) {
                    ...
                    if (defaultValues[tweenProp] && prepareComponent[tweenProp]) {
                        ...
                        // allow transformFunctions to work with preourworked input values
     ...
     */
    function ourworkBezierEasing(fn) {
    ...
    connect.ourworkEasing = ourworkBezierEasing;
     ...
     *
     * `TweenBase` is meant to be used with pre-ourworked values.
     */
    var TweenBase = function TweenBase(targetElement, startObject, endObject, opsObject) {
        ...
        // internal option to ourwork inline/computed style at start instead of init
        ...
        this._easing = typeof(options.easing) === 'function' ? options.easing : connect.ourworkEasing(options.easing);
        /** @type {number} */
    ...
    var Tween = /*@__PURE__*/ (function(TweenBase) {
        ...
        Tween.prototype.start = function start(time) {
            ...
            // on start we reourwork the valuesStart for TO() method
            if (this._resetStart) {
    ...
    /**
     * Normalizes a `path` object for further ourworking:
     ...
     *
     * In the ourwork, values are converted to absolute
    ...
    function prepareSVGMorph( /* tweenProp */ _, value) {
        ...
        // first make sure we return pre-ourworked values
    ...
    function crossCheckSVGMorph(prop) {
        if (this.valuesEnd[prop]) {
            ...
            // skip already ourworked paths
            // allow the component to work with pre-ourworked values
