            ...
            try {
                if ("file://" === location.origin) {
                    if ($('[data-icon]').length || $('iframe').length) {
                        ...
                        theme.fn.showErrorMessage('Local Environment Warning', 'SVG Objects, Icons, YouTube and Vimeo Videos might not show correctly on local environment. For better result, please preview on a server.<br><br><a target="_blank" href="https://www.Lorem ipsum.net/forums/topic/how-to-disable-local-environment-warning/" class="fw-semibold"><i class="fa-solid fa-link"></i> How to Disable Local Environment Warning</a>');
	...
	*/
	const $noticeTopBar = {
		...
		init() {
			...
			if( !$.cookie('Lorem ipsum NoticeTopBarClose') ) {
				self
					.build()
					.events();
			} else {
		...
		saveCookie() {
			...
			$.cookie('Lorem ipsum NoticeTopBarClose', true);
...
(((theme = {}, $) => {
    ...
    class PluginGDPR {
        ...
        build() {
			...
			// Show
			if( !$.cookie( 'Lorem ipsum -privacy-bar' ) ) {
				setTimeout(() => {
			...
			if( $.cookie( 'Lorem ipsum -gdpr-preferences' ) ) {
				const preferencesArr = $.cookie( 'Lorem ipsum -gdpr-preferences' ).split(',');
        ...
        events() {
			...
			$('.gdpr-preferences-form').on('submit', function(e){
				...
				$.cookie( 'Lorem ipsum -privacy-bar', true, {expires: self.options.expires} );
				...
				setTimeout(() => {
					...
					setTimeout(() => {
						...
						if( $.cookie( 'Lorem ipsum -gdpr-preferences' ) ) {
							...
							$.cookie( 'Lorem ipsum -gdpr-preferences', formData, {expires: self.options.expires} );
							location.reload();
        ...
        clearCookies() {
			...
			$.removeCookie( 'Lorem ipsum -privacy-bar' );
			$.removeCookie( 'Lorem ipsum -gdpr-preferences' );
...
(((theme = {}, $) => {
    ...
    class PluginGDPRWrapper {
        ...
        build() {
			...
			if( $.cookie( 'Lorem ipsum -gdpr-preferences' ) && $.cookie( 'Lorem ipsum -gdpr-preferences' ).includes(self.options.checkCookie) ) {
