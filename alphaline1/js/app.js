...
function loadDefaultContent() {
    contentData = {
        ...
        capabilities: [{
            ...
            image: "https://images.unsplash.com/photo-1590496793907-4e9ed0e9c5f2?w=400&h=300&fit=crop",
...
function renderContent() {
    ...
    capabilitiesContainer.innerHTML = contentData.capabilities.map(cap => `
            ...
            const insightsFooter = document.getElementById('footerContentInsights');
